...
public class JsonTimestampExtractor implements TimestampExtractor {
    ...
    public long extract(ConsumerRecord<Object, Object> record, long partitionTime) {
        if (record.value() instanceof PageViewProcessor.PageView) {
            return ((PageViewProcessor.PageView) record.value()).timestamp;
        }
        if (record.value() instanceof PageViewProcessor.UserProfile) {
            return ((PageViewProcessor.UserProfile) record.value()).timestamp;
        }
